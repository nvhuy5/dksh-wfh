...
from app.fastapi_celery.processors.process_functions.master_validation import (
    MasterValidation,
)
...
def test_masterdata_itemvalue(base_path: Path) -> None:
    ...
    masterdata = base_master_processor.BaseMasterDataProcessor(
...
def test_parse_file_to_json_from_s3(mock_processor_class: MagicMock) -> None:
    ...
    processor = base_master_processor.BaseMasterDataProcessor(
